...
/*	public function edit($id = null) {
	...
	} Este é o edit do crud*/
	
	public function edit($id = null) { /*  edit que implementei*/
        $this->User->id = $id;
        if (!$this->User->exists()) {
            throw new NotFoundException(__('Invalid user'));
        }
 ...
 * @return void
 */
	/* public function delete($id = null) {     /* delete do crud
		$this->User->id = $id;
		if (!$this->User->exists()) {
			throw new NotFoundException(__('Invalid user'));
		}
	 ...
	 public function delete($id = null) {    /* delete implementado*/
        if (!$this->request->is('post')) {
